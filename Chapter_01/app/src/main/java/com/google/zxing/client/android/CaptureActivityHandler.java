...
public final class CaptureActivityHandler extends Handler {
    ...
    public CaptureActivityHandler(CaptureActivityInterface.a captureActivityInterface, ELinkProcessType processType, CameraManager cameraManager) {
    ...
    public void handleMessage(Message message) {
        ...
        if (what == R.id.decode_failed) { // 4
            ...
            state = State.SUCCESS;
            this.captureActivityInterface.handleDecode((TodoResult) message.obj);
