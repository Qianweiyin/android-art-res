...
package com.qwy.chapter_01.mlkit.camera
...
import com.qwy.chapter_01.mlkit.Utils
 ...
 * 相关的[图形]项应该使用 [.translateX] 和 [.translateY] 将预览坐标转换为视图坐标。
 */
class GraphicOverlay(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    fun setCameraInfo(cameraSource: CameraSource) {
        ...
        Log.e("QwyGraphicOverlay", "previewWidth : $previewWidth  + previewHeight : $previewHeight")
