...
package com.qwy.chapter_01.mlkit.settings
...
import com.qwy.chapter_01.mlkit.camera.CameraSizePair
...
object PreferenceUtils {
    ...
    fun getBarcodeReticleBox(overlay: GraphicOverlay): Rect {
        val context = overlay.context
        ...
        return Rect((cx - boxWidth / 2).toInt(), (cy - boxHeight / 2).toInt(),
            (cx + boxWidth / 2).toInt(), (cy + boxHeight / 2).toInt()
        )
    }
