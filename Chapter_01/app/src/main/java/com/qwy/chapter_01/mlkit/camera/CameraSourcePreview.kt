...
class CameraSourcePreview(context: Context, attrs: AttributeSet) : FrameLayout(context, attrs) {
    ...
    private fun startIfReady() {
        Log.e(
            "QwyStartIfReady",
            "startRequested : $startRequested   surfaceAvailable : $surfaceAvailable"
        )
    ...
    override fun onLayout(changed: Boolean, left: Int, top: Int, right: Int, bottom: Int) {
        ...
        if (childHeight <= layoutHeight) {
            ...
            for (i in 0 until childCount) {
                ...
                Log.e("QwyScan", "childView.id : " + childView.id)
//                Log.e("QwyScan", "R.id.static_overlay_container : " + R.id.static_overlay_container)
