...
import com.qwy.chapter_01.mlkit.CameraInputInfo
import com.qwy.chapter_01.mlkit.InputInfo
import com.qwy.chapter_01.mlkit.ScopedExecutor
    ...
    private fun processLatestFrame(graphicOverlay: GraphicOverlay) {
        ...
        detectInImage(image)
            .addOnSuccessListener(executor) { results: T ->
                Log.e("QwyFrameProcessorBase", "Latency is: ${SystemClock.elapsedRealtime() - startMs}")
